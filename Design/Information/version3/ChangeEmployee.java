 ...
 *
 */
public class ChangeEmployee extends Application {
	...
	public void start(Stage primaryStage, ArrayList<Employee> list, int index) throws Exception {
        ...
        saveButton.setOnAction(event -> {
        	...
        	employee.setAddress(addAddress.getText());
        	employee.setPhoneNumber(addPhoneNumber.getText());
        	employee.setEmail(addEmai.getText());
        	employee.setOffice(addOfficeCol.getText());
        	employee.setSalary(addSalaryCol.getText());
        	employee.setTime(addTime.getText());
 ...
 *
 */
class ChangeEmployeeSearch extends Application {
	@Override
	public void start(Stage primaryStage) throws Exception {
    ...
    searchButton.setOnAction(event -> {
		...
		if (index >= 0) {
			try {
				...
				changeEmployee.start(newStage, list, index);
			} catch (Exception e) {
				e.printStackTrace();
			}
		} else {
