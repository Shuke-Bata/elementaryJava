 ...
 *
 */
public class ChangeStudent extends Application {
	...
	public void start(Stage primaryStage, ArrayList<Student> list, int index) throws Exception {
        ...
        saveButton.setOnAction(event -> {
        	...
        	student.setName(addName.getText());
        	student.setAddress(addAddress.getText());
        	student.setPhoneNumber(addPhoneNumber.getText());
        	student.setEmail(addEmai.getText());
        	student.setGrade(addGrade.getText());
 ...
 *
 */
class ChangeStudentSearch extends Application {
	@Override
	public void start(Stage primaryStage) throws Exception {
    ...
    searchButton.setOnAction(event -> {
		...
		if (index >= 0) {
			try {
	    		...
	    		changeStudent.start(newStage, list, index);
			} catch (Exception e) {
				e.printStackTrace();
			}
		} else {
