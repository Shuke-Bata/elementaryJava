 ...
 *
 */
public class ChangePostgraduate extends Application {
	...
	public void start(Stage primaryStage, ArrayList<Postgraduate> list, int index) throws Exception {
        ...
        saveButton.setOnAction(event -> {
        	...
        	postgraduate.setName(addName.getText());
        	postgraduate.setAddress(addAddress.getText());
        	postgraduate.setPhoneNumber(addPhoneNumber.getText());
        	postgraduate.setEmail(addEmai.getText());
        	postgraduate.setGrade(addGrade.getText());
        	postgraduate.setStudy(addStudy.getText());
        	postgraduate.setTutor(addTutor.getText());
        	
        	list.set(index, postgraduate);
 ...
 *
 */
class ChangePostgraduateSearch extends Application {
	@Override
	public void start(Stage primaryStage) throws Exception {
    ...
    searchButton.setOnAction(event -> {
		...
		if (index >= 0) {
			try {
				ChangePostgraduate changePostgraduate = new ChangePostgraduate();
				changePostgraduate.start(newStage, list, index);
			} catch (Exception e) {
				e.printStackTrace();
			}
		} else {
