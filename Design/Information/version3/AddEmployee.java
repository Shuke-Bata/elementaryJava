...
public class AddEmployee extends Application {
	 ...
	 */
	public static void saveToFile(ArrayList<String> employee) throws FileNotFoundException {
		try(PrintWriter output = new PrintWriter(new FileOutputStream("employee.txt", true));){
