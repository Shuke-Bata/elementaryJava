 ...
 *
 */
public class DeleteFaculty extends Application {
 ...
 *
 */
class DeleteFacultySearch extends Application {
	@Override
	public void start(Stage primaryStage) throws Exception {
    ...
    searchButton.setOnAction(event -> {
		...
		if (index >= 0) {
			try {
				...
				deleteFaculty.start(newStage, list, index);
			} catch (Exception e) {
				e.printStackTrace();
			}
		} else {
